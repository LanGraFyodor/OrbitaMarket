...
Финальный инструментальный прогон выполнен официальными Docker-образами. Gitleaks проверил текущее содержимое проекта, Semgrep проверил Java, TypeScript и Rust с включением незакоммиченных файлов и исключением только build-кэшей.
